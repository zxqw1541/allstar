...
! function(a) {
    ...
    function r(b, c, d, e, f, g) {
        ...
        return {
            ...
            addMatch: function(a, c) {
                var f = h.length,
                    i = null !== a ? a() : [{
                        source: b.round(d - 1).match(2 * f).winner
                    }, {
                        source: b.round(d - 1).match(2 * f + 1).winner
                    }],
    ...
    var v = function(a, b) {
        ...
        x = function(a, b, c, d, e, f) {
            return function() {
                if (e % 2 === 0 && 0 === f) return [{
                    source: a.round(0).match(2 * d).loser
                }, {
                    source: a.round(0).match(2 * d + 1).loser
                }];
                var g = f % 2 === 0 ? c - d - 1 : d;
                return [{
                    source: b.round(2 * f).match(d).winner
                }, {
                    source: a.round(f + 1).match(g).loser
                }]
            }
        },
        y = function(a, b) {
